...
func TestAll(t *testing.T) {
	htmlBody := strings.NewReader(`
		...
		<body>
		    ...
		    <a href="https://monzo.com/about/">Link with slash</a>
			<a href="https://monzo.com/about">Same link without slash</a>
	...
	for i, link := range links {
		...
		if i == 1 {
			...
			if link.Href != "https://monzo.com/about" {
				t.Error("Anchor link href is invalid")
			}
...
func TestRemoveTrailingSlash(t *testing.T) {
	href := "https://monzo.com/about/"
	cleanHref := removeTrailingSlash(href)

	if strings.Compare(cleanHref, "https://monzo.com/about") != 0 {
